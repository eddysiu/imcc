...
if (isset($_POST["submit"])){
	...
	<meta http-equiv=Refresh content="2; url=library.php?tab=<?php echo $tab ?>" />
	<div class="main">
...
<?php
	...
	<meta http-equiv=Refresh content="5; url=library.php?tab=<?php echo $tab ?>">
	<div class="main">
...
?>
	<div class="main">
		<p><h1>Maritime Library: <?php echo $title ?></h1>
		<form action="./library.php" method="post" name="library">
...
<script type="text/javascript">
	window.location = "./library_search.php";
</script>
<?php
		}
	} else {
